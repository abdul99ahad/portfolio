...
const Projects = () => {
    ...
    const projects: Project[] = [
        {
            title: "Camunda Modeler — Carbon Design System",
            role: "Open Source Contributor",
            desc: "Integrated IBM Carbon Design System into Camunda Modeler, improving UI consistency and accessibility for a globally-used BPMN modeling tool.",
            fullDesc: [
                "Integrated IBM's Carbon Design System into Camunda Modeler's UI.",
                "Improved UI consistency and accessibility across the application.",
                "Delivered end-to-end changes across React components, styles, and tests.",
                "Merged as a significant open-source contribution to the Camunda ecosystem."
            ],
            tags: ["React", "Node.js", "Carbon Design System", "TypeScript", "Open Source"],
            links: [
                { label: "PR #4511 on GitHub", url: "https://github.com/camunda/camunda-modeler/pull/4511" }
            ]
        },
        {
            title: "bpmn-auto-layout",
            role: "Contributor & Release Owner",
            desc: "Improved and released a major version of an open-source utility for automatic BPMN diagram layout across the bpmn.io ecosystem.",
            fullDesc: [
                "Improved the core layout algorithm for automatic BPMN diagram layout generation.",
                "Released a major version of the library, enabling automatic layout for complex BPMN diagrams.",
                "Maintained the library within the broader bpmn.io open-source ecosystem.",
                "Collaborated with the Camunda / bpmn.io team on the release process."
            ],
            tags: ["Node.js", "JavaScript", "BPMN", "Open Source"],
            links: [
                { label: "bpmn-io/bpmn-auto-layout", url: "https://github.com/bpmn-io/bpmn-auto-layout" }
            ]
        },
        {
            ...
            fullDesc: [
                "Built real-time bi-directional communication using WebSockets (Socket.io).",
                "Implemented user rooms, live messaging, and online/offline presence indicators.",
                "Developed a clean React UI with responsive design.",
                "Built backend with Node.js and Express.js to handle connection management."
            ],
            tags: ["React", "Node.js", "Express.js", "WebSockets"],
            links: [
                { label: "abdul99ahad/react-chat-app", url: "https://github.com/abdul99ahad/react-chat-app" }
            ]
        },
    ];
