            ...
            <div className="container mx-auto px-4 md:px-8 grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-4 mb-10">
                        ...
                        {/* TODO: Add your CV PDF to /public/Abdul_Ahad_CV.pdf and re-enable this link */}
                        {/* <a href="/Abdul_Ahad_CV.pdf" download className="px-8 py-3 border border-slate-700 hover:border-violet-500 hover:text-violet-400 text-slate-300 rounded-lg font-medium transition-all flex items-center gap-2 group">
                ...
                >
                    ...
                    <div className="w-full h-[500px] border border-slate-800 bg-slate-900/50 rounded-2xl relative overflow-hidden group">
                        ...
                        <div className="p-6 font-mono text-sm space-y-4 text-slate-400">
                            ...
                            <div className="pl-6">
                                <span className="text-slate-500">name:</span> <span className="text-green-400">'Abdul Ahad'</span>,
                            </div>
                            <div className="pl-6">
                                <span className="text-slate-500">role:</span> <span className="text-green-400">'Software Engineer'</span>,
                            </div>
                            <div className="pl-6">
